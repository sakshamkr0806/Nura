  ...
  const features = [
    {
      ...
      description:
        "Log dates, track symptoms, and predict your next cycle with precision.",
      icon: Calendar,
    ...
    },
    {
      ...
      description:
        "Keep a detailed journal of your mood, sleep, water intake, and physical symptoms.",
      icon: Activity,
    ...
    },
    {
      title: "AI Insights",
      description:
        "Get personalized wellness recommendations based on your unique patterns.",
      icon: Brain,
    ...
    },
    {
      title: "Smart Alerts",
      description:
        "Receive medical suggestions and attention alerts when anomalies are detected.",
      icon: Bell,
    ...
    },
    {
      ...
      description:
        "Learn about your body with curated, science-backed articles and guides.",
      icon: BookOpen,
    ...
    },
    {
      ...
      description:
        "Export beautiful PDF reports to share with your healthcare provider.",
      icon: FileText,
      ...
      <main className="pt-32 pb-20 px-6 sm:px-12 max-w-7xl mx-auto">
        <div className="text-center max-w-3xl mx-auto space-y-8 animate-in fade-in slide-in-from-bottom-8 duration-700 delay-100 fill-mode-both">
          ...
          <p className="text-lg sm:text-xl text-zinc-600 dark:text-zinc-400 max-w-2xl mx-auto leading-relaxed">
            CycleWell is an AI-powered platform designed to help you track your
            cycle, understand your symptoms, and gain actionable insights into
        ...
        <div className="mt-32 space-y-12">
          <div className="text-center animate-in fade-in duration-700 delay-300 fill-mode-both">
            ...
            <p className="mt-4 text-zinc-600 dark:text-zinc-400">
              Comprehensive tools for a healthier you.
            </p>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {features.map((feature, index) => (
              ...
              >
                <div
                  className={`inline-flex p-3 rounded-2xl ${feature.color} mb-6 transition-transform group-hover:scale-110 duration-300`}
                >
      ...
      <footer className="border-t border-zinc-200 dark:border-zinc-800 bg-zinc-50 dark:bg-zinc-950 mt-20">
        <div className="max-w-7xl mx-auto px-6 py-12 flex flex-col sm:flex-row items-center justify-between gap-4">
          ...
          <p className="text-sm text-zinc-500">
            © 2026 CycleWell. All rights reserved.
          </p>
        </div>
      </footer>
    </div>
