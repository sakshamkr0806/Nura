...
const CATEGORIES = ["All", "Cycles", "Nutrition", "Mental Health", "Myth-Busting", "Lifestyle"]
  ...
  return (
    <div className="p-6 space-y-8 max-w-7xl mx-auto">
      <header className="space-y-4">
        <div>
          <h1 className="text-3xl font-bold tracking-tight text-foreground">Hormonal Education Hub</h1>
          <p className="text-muted-foreground text-lg">Empower yourself with evidence-based hormonal health knowledge.</p>
        </div>
